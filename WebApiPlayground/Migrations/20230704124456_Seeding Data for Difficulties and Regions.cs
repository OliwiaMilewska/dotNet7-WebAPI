    ...
    public partial class SeedingDataforDifficultiesandRegions : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("1a0d5a3b-f9aa-4330-a2b7-6bf02f9b74f2"), "Medium" },
                    { new Guid("a78906f9-fb0f-42bb-8498-0346d5d46cc5"), "Hard" },
                    { new Guid("c2fe857b-4580-4240-8430-8d5b2572846d"), "Easy" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { new Guid("e489f49a-b7ae-4b5a-9e50-9d39e928f67a"), "AKL", "Auckland", "https://cdn.pixabay.com/photo/2014/03/05/10/21/cornwall-park-279966_1280.jpg" },
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.DeleteData(
                table: "Difficulties",
                keyColumn: "Id",
                keyValue: new Guid("1a0d5a3b-f9aa-4330-a2b7-6bf02f9b74f2"));

            migrationBuilder.DeleteData(
                table: "Difficulties",
                keyColumn: "Id",
                keyValue: new Guid("a78906f9-fb0f-42bb-8498-0346d5d46cc5"));

            migrationBuilder.DeleteData(
                table: "Difficulties",
                keyColumn: "Id",
                keyValue: new Guid("c2fe857b-4580-4240-8430-8d5b2572846d"));
            ...
            migrationBuilder.DeleteData(
                table: "Regions",
                keyColumn: "Id",
                keyValue: new Guid("e489f49a-b7ae-4b5a-9e50-9d39e928f67a"));
